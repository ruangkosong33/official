            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <!-- Form -->
                        <form action="{{route('citykab.update', $citykab->id)}}" class="form-horizontal" enctype="multipart/form-data" method="post">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        id="name_citykab" placeholder="Kota/Kabupaten" value="{{old('name_city') ?? $citykab->name_citykab}}">
