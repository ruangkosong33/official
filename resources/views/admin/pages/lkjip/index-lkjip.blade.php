        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Data LKJIP</h3>
                    <div class="card-tools">
                    <ul class="nav nav-pills ml-auto">
                        <li class="nav-item">
                            <a class="nav-link active" href="{{route('lkjip.create')}}"><i class="fas fa-plus"></i></a>
                        </li>
                    </ul>
                    </div>
                </div>
                            ...
                            @foreach ($lkjip as $key=>$lkjips)
                              <tr>
                                ...
                                <td>
                                    ...
                                    <form method="post" action="{{route('lkjip.destroy', $lkjips->id)}}" class="d-inline">
                                      @csrf
                                      @method('DELETE')
