            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <!-- Form -->
                        <form action="{{route('filepad.update',['filepad'=>$filepad])}}" class="form-horizontal" enctype="multipart/form-data" method="post">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="file" name="file_filepad" class="form-control @error('file_filepad') is-invalid @enderror" id="file_itemfilepad">
