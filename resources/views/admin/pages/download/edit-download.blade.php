                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Edit Data Kategori Download</h3>
                        </div>

                        <!-- Form -->
                        <form action="{{route('download.update', $download->id)}}" class="form-horizontal" enctype="multipart/form-data" method="post">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        id="category_download" placeholder="Download" value="{{old('category_download') ?? $download->category_download}}">
