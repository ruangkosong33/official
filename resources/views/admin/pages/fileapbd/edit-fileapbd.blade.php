                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Edit Data File APBD</h3>
                        </div>

                        <!-- Form -->
                        <form action="{{route('fileapbd.update', $fileapbd->id)}}" class="form-horizontal" enctype="multipart/form-data" method="post">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        id="title_fileapbd" placeholder="Judul" value="{{old('title_fileapbd') ?? $fileapbd->title_fileapbd}}">
