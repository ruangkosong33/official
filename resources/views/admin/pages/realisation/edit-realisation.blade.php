                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Edit Data Realisasi Fisik & Keuangan</h3>
                        </div>

                        <!-- Form -->
                        <form action="{{route('realisation.edit', $realisation->id)}}" class="form-horizontal" enctype="multipart/form-data" method="post">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        id="title_realisation" placeholder="Realisasi Fisik & Keuangan" value="{{old('title_realisation') ?? $realisation->title_realisation}}">
