        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Data Pendapatan Asli Daerah</h3>
                    <div class="card-tools">
                    <ul class="nav nav-pills ml-auto">
                        <li class="nav-item">
                            <a class="nav-link active" href="{{route('pad.create')}}"><i class="fas fa-plus"></i></a>
                        </li>
                    </ul>
                    </div>
                </div>
                            ...
                            @foreach ($pad as $key=>$pads)
                              <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('filepad.index', $pads->id)}}" class="btn btn-info btn-sm">
