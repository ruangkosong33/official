                ...
                <form action="{{route('formationhistory.update', $formationhistory->id)}}" method="post" class="form-horizontal">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                    <textarea class="form-control @error('description_formationhistory') is-invalid @enderror" id="editor"
                                    name="description_formationhistory">{{ old('description_formationhistory', $formationhistory->description_formationhistory ?? '') }}</textarea>
