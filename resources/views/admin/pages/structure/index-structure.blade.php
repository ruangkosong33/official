            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <ul class="nav nav-pills ml-auto">
                        <li class="nav-item">
                            <a class="nav-link active" href="{{route('structure.create')}}"><i class="fas fa-plus"></i></a>
                        </li>
                    </ul>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered table-striped" id="myTable">
                        ...
                        <tbody>
                            @foreach ($structure as $structures)
                              <tr>
                                <td><img src="{{asset('/uploads/image-structure/'. $structures->image_structure)}}" width="50px"></td>
                                <td>
                                    <a href="{{route('structure.edit', $structures->id)}}" class="btn btn-warning btn-sm">
                                      <i class="fas fa-edit"></i>
                                    </a>
                                    <form method="post" action="{{route('structure.destroy', $structures->id)}}" class="d-inline">
                                      @csrf
                                      @method('DELETE')
