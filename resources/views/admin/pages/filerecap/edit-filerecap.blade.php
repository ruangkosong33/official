                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Edit Data File Rekapitulasi Bagi Hasil</h3>
                        </div>

                        <!-- Form -->
                        <form action="{{route('filerecap.update', ['filerecap'=>$filerecap])}}" class="form-horizontal" enctype="multipart/form-data" method="post">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="citykab_id" class="form-control @error('citykab_id') is-invalid @enderror" id="citykab_id">
                                            ...
                                            @if($citykabs->id == $filerecap->citykab_id)
                                            <option value={{$citykabs->id}} selected='selected'>{{$citykabs->name_citykab}}</option>
                                            @endif
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        id="title_filerecap" placeholder="Judul" value="{{old('title_recap') ?? $filerecap->title_filerecap}}">
