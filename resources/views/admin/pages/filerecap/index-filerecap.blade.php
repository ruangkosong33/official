...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Kategori File Rekapitulasi Bagi Hasil</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Data File Rekapitulasi Bagi Hasil</h3>
                    <div class="card-tools">
                    <ul class="nav nav-pills ml-auto">
                        <li class="nav-item">
                            <a class="nav-link active" href="{{route('filerecap.create', ['recap'=>$recap])}}"><i class="fas fa-plus"></i></a>
                        </li>
                    </ul>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <table class="table table-bordered table-striped" id="myTable">
                        ...
                        <tbody>
                            @foreach ($filerecap as $key=>$filerecaps)
                              <tr>
                                <td>{{$key+1}}</td>
                                <td>{{$filerecaps->citykab->name_citykab}}</td>
                                <td>{{$filerecaps->recap->periode}}</td>
                                <td>{{$filerecaps->recap->year}}</td>
