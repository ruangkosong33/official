            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <!-- Form -->
                        <form action="{{route('event.update', $event->id)}}" class="form-horizontal" enctype="multipart/form-data" method="post">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        id="title_responsible" placeholder="Agenda Kegiatan" value="{{old('title_event') ?? $event->title_event}}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        id="place" value="{{old('place') ?? $event->place}}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="description_event" class="form-control @error('description_event') is-invalid @enderror"
                                        id="place" value="{{old('description_event') ?? $event->description_event}}">
                                ...
                                <div class="form-group row">
                                    <label for="date_event" class="col-sm-2 col-form-label">Deskripsi</label>
                                    <div class="col-sm-10">
                                        <input type="date" name="date_event" class="form-control @error('date_event') is-invalid @enderror"
                                        id="place" value="{{old('date_event') ?? $event->date_event}}">
