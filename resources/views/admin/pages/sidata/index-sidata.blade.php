            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <ul class="nav nav-pills ml-auto">
                        <li class="nav-item">
                            <a class="nav-link active" href="{{route('sidata.create')}}"><i class="fas fa-plus"></i></a>
                        </li>
                    </ul>
                    </div>
                </div>
                            ...
                            @foreach ($sidata as $key=>$sidatas)
                              <tr>
                                ...
                                <td>
                                    ...
                                    <form method="post" action="{{route('sidata.destroy', $sidatas->id)}}" class="d-inline">
                                      @csrf
                                      @method('DELETE')
