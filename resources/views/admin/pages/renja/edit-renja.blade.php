                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Edit Data Rencana Kerja</h3>
                        </div>

                        <!-- Form -->
                        <form action="{{route('renja.update', $renja->id)}}" class="form-horizontal" enctype="multipart/form-data" method="post">
                            @csrf
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        id="name_city" placeholder="Renja" value="{{old('title_renja') ?? $renja->title_renja}}">
