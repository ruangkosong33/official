...
<head>
    ...
    <title> Home One || sinace || sinace HTML 5 Template </title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
                    ...
                    <div class="main-menu__wrapper-inner">
                        ...
                        <div class="main-menu__call">
                            ...
                            <div class="main-menu__call-content">
                                ...
                                <h5 class="main-menu__call-number"><a href="tel:928009850">+92 (8800)-9850</a></h5>
                            </div>
                        </div>
    ...
    <script src="{{asset('rk99/assets/vendors/jquery/jquery-3.6.4.min.js')}}"></script>
    <script src="{{asset('rk99/assets/vendors/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('rk99/assets/vendors/jarallax/jarallax.min.js')}}"></script>
    <script src="{{asset('rk99/assets/vendors/jquery-ajaxchimp/jquery.ajaxchimp.min.js')}}"></script>
    <script src="{{asset('rk99/assets/vendors/jquery-appear/jquery.appear.min.js')}}"></script>
    <script src="{{asset('rk99/assets/vendors/jquery-circle-progress/jquery.circle-progress.min.js')}}"></script>
    <script src="{{asset('rk99/assets/vendors/jquery-magnific-popup/jquery.magnific-popup.min.js')}}"></script>
    <script src="{{asset('rk99/assets/vendors/jquery-validate/jquery.validate.min.js')}}"></script>
    <script src="{{asset('rk99/assets/vendors/nouislider/nouislider.min.js')}}"></script>
    <script src="{{asset('rk99/assets/vendors/odometer/odometer.min.js')}}"></script>
    <script src="{{asset('rk99/assets/vendors/swiper/swiper.min.js')}}"></script>
    <script src="{{asset('rk99/assets/vendors/tiny-slider/tiny-slider.min.js')}}"></script>
    <script src="{{asset('rk99/assets/vendors/wnumb/wNumb.min.js')}}"></script>
    <script src="{{asset('rk99/assets/vendors/wow/wow.js')}}"></script>
    <script src="{{asset('rk99/assets/vendors/isotope/isotope.js')}}"></script>
    <script src="{{asset('rk99/assets/vendors/countdown/countdown.min.js')}}"></script>
    <script src="{{asset('rk99/assets/vendors/owl-carousel/owl.carousel.min.js')}}"></script>
    <script src="{{asset('rk99/assets/vendors/bxslider/jquery.bxslider.min.js')}}"></script>
    <script src="{{asset('rk99/assets/vendors/bootstrap-select/js/bootstrap-select.min.js')}}"></script>
    <script src="{{asset('rk99/assets/vendors/vegas/vegas.min.js')}}"></script>
    <script src="{{asset('rk99/assets/vendors/jquery-ui/jquery-ui.js')}}"></script>
    <script src="{{asset('rk99/assets/vendors/timepicker/timePicker.js')}}"></script>
    <script src="{{asset('rk99/assets/vendors/circleType/jquery.circleType.js')}}"></script>
    <script src="{{asset('rk99/assets/vendors/circleType/jquery.lettering.min.js')}}"></script>
    <script src="{{asset('rk99/assets/vendors/highcharts/highcharts.min.js')}}"></script>
    <script src="{{asset('rk99/assets/vendors/touch/touch-paid-min.js')}}"></script>
    <script src="{{asset('rk99/assets/js/sip-calculator.js')}}"></script>
    <script src="{{asset('rk99/assets/js/lumpsum-calculator.js')}}"></script>
    <script src="{{asset('rk99/assets/js/inflation.js')}}"></script>
    <script src="{{asset('rk99/assets/js/target-amount-calculator.js')}}"></script>
    <script src="{{asset('rk99/assets/js/tab.js')}}"></script>
    <script src="{{asset('rk99/assets/vendors/bootstrap-datepicker/bootstrap-datepicker.min.js')}}"></script>




    <!-- template js -->
    <script src="{{asset('rk99/assets/js/sinace.js')}}"></script>
</body>
