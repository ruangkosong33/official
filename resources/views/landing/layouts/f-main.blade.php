            ...
            <div class="main-slider__carousel owl-carousel owl-theme thm-owl__carousel"
                ...
                <div class="item main-slider__slide-1">
                    ...
                    <div class="main-slider__shape-1 float-bob-y">
                        <img src="{{asset('rk99/assets/images/shapes/main-slider-shape-1.png')}}" alt="">
                    </div>
                    <div class="main-slider__shape-2 img-bounce">
                        <img src="{{asset('rk99/assets/images/shapes/main-slider-shape-2.png')}}" alt="">
                    </div>
                    <div class="main-slider__shape-3">
                        <img src="{{asset('rk99/assets/images/shapes/main-slider-shape-3.png')}}" alt="">
                    </div>
                    <div class="main-slider__shape-4">
                        <img src="{{asset('rk99/assets/images/shapes/main-slider-shape-4.png')}}" alt="">
                    </div>
                    <div class="main-slider__shape-5 float-bob-x">
                        <img src="{{asset('rk99/assets/images/shapes/main-slider-shape-5.png')}}" alt="">
                    </div>
                    <div class="container">
                        ...
                        <div class="about-one__left">
                            <div class="about-one__img-box wow slideInLeft" data-wow-delay="100ms"
                                ...
                                <div class="about-one__img">
                                    <img src="{{asset('rk99/assets/images/resources/about-one-img-1.jpg')}}" alt="">
                                    <div class="about-one__shape-1 float-bob-x">
                                        <img src="assets/images/shapes/about-one-shape-1.png')}}" alt="">
                                    </div>
                                    <div class="about-one__shape-2 img-bounce">
                                        <img src="{{asset('rk99/assets/images/shapes/about-one-shape-2.png')}}" alt="">
                                    </div>
                                </div>
                                <div class="about-one__img-2">
                                    <img src="{{asset('rk99/assets/images/resources/about-one-img-2.jpg')}}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="about-one__right">
                            ...
                            <div class="about-one__btn-box">
                                <div class="about-one__shape-3 float-bob-x">
                                    <img src="{{asset('rk99/assets/images/shapes/about-one-shape-3.png')}}" alt="">
                                </div>
                    ...
                    <div class="project-one__carousel owl-carousel owl-theme thm-owl__carousel" data-owl-options='{
                            ...
                            <div class="project-one__single">
                                <div class="project-one__img-box">
                                    <div class="project-one__img">
                                        <img src="{{asset('rk99/assets/images/project/project-1-1.jpg')}}" alt="">
                                    </div>
                                </div>
                        ...
                        <div class="item">
                            <div class="project-one__single">
                                <div class="project-one__img-box">
                                    <div class="project-one__img">
                                        <img src="{{asset('rk99/assets/images/project/project-1-2.jpg')}}" alt="">
                                    </div>
                                </div>
                                <div class="project-one__content">
                                    <p>Finance</p>
                        ...
                        <div class="item">
                            <div class="project-one__single">
                                <div class="project-one__img-box">
                                    <div class="project-one__img">
                                        <img src="{{asset('rk99/assets/images/project/project-1-3.jpg')}}" alt="">
                                    </div>
                                </div>
                                <div class="project-one__content">
                                    <p>Finance</p>
