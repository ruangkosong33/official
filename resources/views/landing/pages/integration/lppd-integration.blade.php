    ...
    <section class="page-header">
        ...
        <div class="container">
            <div class="page-header__inner">
                <h2>Laporan Penyelenggaraan Pemerintah Daerah</h2>
                <div class="thm-breadcrumb__inner">
                    <ul class="thm-breadcrumb list-unstyled">
                        ...
                        <li><span>/</span></li>
                        <li>Laporan Penyelenggaraan Pemerintah Daerah</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <section class="faq-search">
        <div class="container">
            <div class="section-title text-center">
                ...
                <h2 class="section-title__title">Laporan Penyelenggaraan Pemerintah Daerah</span></h2>
            </div>
        </div>
    </section>
    <!--Faq Search End-->
            ...
            <div class="row pb-5">
                <table id="datatable1" class="display" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$lppd->title_lppd}}</td>
                            <td>{{$lppd->year}}</td>
                            <td>{{ $lppd->created_at->format('d').' '.$lppd->created_at->monthName.', '.$lppd->created_at->year }}</td>
                            <td><a href="{{route('landing.integration.downloadFileLppd',['slug'=>$lppd->slug])}}" class="thm-btn calculator-menu__btn" target="_blank" rel="nofollow">Unduh</a></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
