                    ...
                    <tbody>
                        @foreach ($renstras as $renstra)
                            <tr>
                                ...
                                <td>{{ $renstra->year }}</td>
                                <td>{{ $renstra->created_at->format('d') . ' ' . $renstra->created_at->monthName . ', ' . $renstra->created_at->year }}
                                </td>
                                <td><a href="{{ route('landing.integration.downloadFileRenstra', ['slug' => $renstra->slug]) }}"
