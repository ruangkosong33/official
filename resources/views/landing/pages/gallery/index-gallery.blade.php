                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="news-one__single">
                            ...
                            <div class="news-one__content">
                                ...
                                <h3 class="news-one__title"><a href="{{route('landing.gallery.detail',['slug'=>$gallery->slug])}}">{{$gallery->title_gallery}}</a></h3>
                            </div>
                            <div class="news-one__hover">
                                <div class="news-one__hover-content">
                                    <h3 class="news-one__hover-title"><a href="{{route('landing.gallery.detail',['slug'=>$gallery->slug])}}">{{$gallery->title_gallery}}</a></h3>
                                </div>
                                <div class="news-one__hover-btn-box">
                                    <a href="{{route('landing.gallery.detail',['slug'=>$gallery->slug])}}">Baca Selengkapnya<span class="icon-right-arrow"></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
