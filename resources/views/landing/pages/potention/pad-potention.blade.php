                    ...
                    <tbody>
                        @foreach ($pad->filepad as $filepad)
                            <tr>
                                ...
                                <td>{{ $filepad->created_at->format('d') . ' ' . $filepad->created_at->monthName . ', ' . $filepad->created_at->year }}
                                </td>
                                <td><a href="{{ route('landing.potention.downloadFileFilepad', ['slug' => $filepad->slug]) }}"
