                ...
                <div class="col-xl-6">
                    <div class="about-four__right" style="margin-right:70px;margin-left: 0px">
                        <div class="section-title text-left">
                            <h2 class="section-title__title">{{$policydirection->title_policydirection}}</h2>
                        </div>
                        <p class="about-four__text">{!! $policydirection->description_policydirection !!}</p>
                    </div>
                </div>
                <div class="col-xl-6">
                    <div class="about-four__left">
                        <div class="about-four__img-box">
                            <div class="about-four__img">
                                <img src="{{asset('fk88/assets/images/bpkad/arah-kebijakan.png')}}" alt="">
                            </div>
