                    ...
                    <tbody>
                        @foreach ($auctions as $auction)
                            <tr>
                                ...
                                <td>{{ $auction->created_at->format('d') . ' ' . $auction->created_at->monthName . ', ' . $auction->created_at->year }}
                                </td>
                                <td><a href="{{ route('landing.publicinfo.downloadFileAuction', ['slug' => $auction->slug]) }}"
