                    ...
                    <tbody>
                        @foreach ($realisations as $realisation)
                            <tr>
                                ...
                                <td>{{ $realisation->created_at->format('d') . ' ' . $realisation->created_at->monthName . ', ' . $realisation->created_at->year }}
                                </td>
                                <td><a href="{{ route('landing.program.downloadFileRealisation', ['slug' => $realisation->slug]) }}"
