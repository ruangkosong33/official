    ...
    <section class="faq-search">
        <div class="container">
            <div class="section-title text-center">
                ...
                <h2 class="section-title__title">Realisasi Fisik & Keuangan</span></h2>
            </div>
        </div>
    </section>
    <!--Faq Search End-->
            ...
            <div class="row pb-5">
                <table id="datatable1" class="display" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$realisation->title_realisation}}</td>
                            <td>{{ $realisation->created_at->format('d').' '.$realisation->created_at->monthName.', '.$realisation->created_at->year }}</td>
                            <td><a href="{{route('landing.program.downloadFileRealisation',['slug'=>$realisation->slug])}}" class="thm-btn calculator-menu__btn" target="_blank" rel="nofollow">Unduh</a></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
