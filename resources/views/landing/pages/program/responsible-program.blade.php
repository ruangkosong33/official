                    ...
                    <tbody>
                        @foreach ($responsibles as $responsible)
                            <tr>
                                ...
                                <td>{{ $responsible->created_at->format('d') . ' ' . $responsible->created_at->monthName . ', ' . $responsible->created_at->year }}
                                </td>
                                <td><a href="{{ route('landing.program.downloadFileResponsible', ['slug' => $responsible->slug]) }}"
