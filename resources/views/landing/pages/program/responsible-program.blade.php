            ...
            <div class="page-header__inner">
                ...
                <div class="thm-breadcrumb__inner">
                    <ul class="thm-breadcrumb list-unstyled">
                        ...
                        <li><span>/</span></li>
                        <li>Penanggung Jawab program dan kegiatan</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <section class="faq-search">
        <div class="container">
            <div class="section-title text-center">
                ...
                <h2 class="section-title__title">Penanggung Jawab program dan kegiatan</span></h2>
            </div>
        </div>
    </section>
    <!--Faq Search End-->
            ...
            <div class="row pb-5">
                <table id="datatable1" class="display" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$responsible->title_responsible}}</td>
                            <td>{{ $responsible->created_at->format('d').' '.$responsible->created_at->monthName.', '.$responsible->created_at->year }}</td>
                            <td><a href="{{route('landing.program.downloadFileResponsible',['slug'=>$responsible->slug])}}" class="thm-btn calculator-menu__btn" target="_blank" rel="nofollow">Unduh</a></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
